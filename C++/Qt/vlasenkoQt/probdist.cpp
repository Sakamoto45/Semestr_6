...
int Probdist::fequal( double a, double b )
{
    return  (fabs(a-b) < Eps ) ? 1 : 0;
}

int Probdist::fcompare( double a, double b )
{
    double d = a-b;
    int res;
...
void Probdist::NORMAL(int IFLAG, double &X, double &PROB)
{
...
double Probdist::pNormal(double x)
{
    double prob;
    NORMAL(1,x,prob);
    return 1.0-prob;
...
double Probdist::xNormal(double prob)
{
    double x, p=1.0-prob;
    NORMAL(2,x,p);
    return x;
...
void Probdist::CHI( int IFLAG, double N, double &X, double &PROB )
{
...
double Probdist::pChi(double x, int n)
{
    double prob;
...
double Probdist::xChi(double prob, int n)
{
    double x, p=1.0-prob;
    CHI(2,(double)n,x,p);
    return x;
