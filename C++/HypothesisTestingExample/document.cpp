...
void Document::set_method(Method method)
{
    method_ = method;
}
...
Document::Method Document::get_method() const
{
    return method_;
}
...
std::vector<int> Document::get_empirical_frequency() const
{
    return chi_square->get_empirical_frequency();
}
