...
\DoxyCodeLine{    }
\DoxyCodeLine{    vector<double> density;}
...
\DoxyCodeLine{    density = distribution\_0.get\_density();}
\DoxyCodeLine{    }
...
\DoxyCodeLine{    distribution\_1.ExtendDensity(k);}
\DoxyCodeLine{    density = distribution\_1.get\_density();}
\DoxyCodeLine{    cout << density.size() << endl; \textcolor{comment}{// 10}}
\DoxyCodeLine{    \textcolor{comment}{// To get full density call ExtendDensity() without args}}
\DoxyCodeLine{    distribution\_1.ExtendDensity();}
\DoxyCodeLine{    density = distribution\_1.get\_density();}
\DoxyCodeLine{    cout << density.size() << endl; \textcolor{comment}{// 144 }}
\DoxyCodeLine{}
...
\DoxyCodeLine{        \textcolor{keywordflow}{break};}
\DoxyCodeLine{    \}}
\DoxyCodeLine{    generator-\/>GenerateSample();}
